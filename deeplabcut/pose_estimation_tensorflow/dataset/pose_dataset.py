...
#                print(sample)
    ...
    def make_batch(self, data_item, scale, mirror):
        ...
        image = imread(os.path.join(self.cfg.project_path,'labeled-data',im_file), mode='RGB') #CT there is an error occuring here. Probably a path that needs to be clarified!! 
